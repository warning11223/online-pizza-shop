...
import {cartItemRemove} from "../redux/actions/cart";

const CartItem = ({name, size, type, totalPrice, amount, id, onPlusItem, onMinusItem}) => {
    const dispatch = useDispatch();

    const onItemRemove = (id) => {
        window.confirm('Удалить заказ?') && dispatch(cartItemRemove(id));
    }
